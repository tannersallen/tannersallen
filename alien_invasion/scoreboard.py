...
class Scoreboard:
    ...
    def prep_level(self):
        ...
        print(f"Level prepared: {self.stats.level}")

    def prep_labels(self):
        """Prepare the labels for High Score, Score, and Level."""
        self.high_score_label = self.font.render("High Score", True, self.text_color,
